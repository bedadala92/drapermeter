...
<head>
	...
	<title>Ng2StateDeclaration | @uirouter/angular</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="state.ng2statedeclaration.html">Ng2StateDeclaration</a>
				</li>
			</ul>
			<h1>Interface Ng2StateDeclaration</h1>
		</div>
	</div>
</header>
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The StateDeclaration object is used to define a state or nested state.
						It should be registered with the <a href="../classes/state.stateregistry.html">StateRegistry</a>.</p>
					</div>
					<h4 id="example-">Example:</h4>
					<pre><code class="lang-js"><span class="hljs-keyword">import</span> {FoldersComponent} <span class="hljs-keyword">from</span> <span class="hljs-string">"./folders"</span>;

<span class="hljs-keyword">export</span> <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">getAllFolders</span>(<span class="hljs-params">FolderService</span>) </span>{
  <span class="hljs-keyword">return</span> FolderService.list();
}

<span class="hljs-comment">// StateDeclaration object</span>
<span class="hljs-keyword">export</span> <span class="hljs-keyword">let</span> foldersState = {
  ...
  <span class="hljs-attr">resolve</span>: [
    { <span class="hljs-attr">token</span>: <span class="hljs-string">'allfolders'</span>, <span class="hljs-attr">deps</span>: [FolderService], <span class="hljs-attr">resolveFn</span>: getAllFolders }
  ]
}
</code></pre>
				</div>
			...
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="tsd-signature-type">StateDeclaration</span>
					</li>
					<li>
						<a href="state.ng2viewdeclaration.html" class="tsd-signature-type">Ng2ViewDeclaration</a>
						<ul class="tsd-hierarchy">
							<li>
								<span class="target">Ng2StateDeclaration</span>
							</li>
						</ul>
					</li>
				</ul>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section ">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="state.ng2statedeclaration.html#__state" class="tsd-kind-icon">$$state</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited tsd-is-external"><a href="state.ng2statedeclaration.html#_context" class="tsd-kind-icon">$context</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited tsd-is-external"><a href="state.ng2statedeclaration.html#_name" class="tsd-kind-icon">$name</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited tsd-is-external"><a href="state.ng2statedeclaration.html#_type" class="tsd-kind-icon">$type</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited tsd-is-external"><a href="state.ng2statedeclaration.html#_uiviewcontextanchor" class="tsd-kind-icon">$ui<wbr>View<wbr>Context<wbr>Anchor</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited tsd-is-external"><a href="state.ng2statedeclaration.html#_uiviewname" class="tsd-kind-icon">$ui<wbr>View<wbr>Name</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="state.ng2statedeclaration.html#abstract" class="tsd-kind-icon">abstract</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="state.ng2statedeclaration.html#bindings" class="tsd-kind-icon">bindings</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="state.ng2statedeclaration.html#component" class="tsd-kind-icon">component</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="state.ng2statedeclaration.html#data" class="tsd-kind-icon">data</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="state.ng2statedeclaration.html#lazyload" class="tsd-kind-icon">lazy<wbr>Load</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="state.ng2statedeclaration.html#loadchildren" class="tsd-kind-icon">load<wbr>Children</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="state.ng2statedeclaration.html#name" class="tsd-kind-icon">name</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="state.ng2statedeclaration.html#onenter" class="tsd-kind-icon">on<wbr>Enter</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="state.ng2statedeclaration.html#onexit" class="tsd-kind-icon">on<wbr>Exit</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="state.ng2statedeclaration.html#onretain" class="tsd-kind-icon">on<wbr>Retain</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="state.ng2statedeclaration.html#params" class="tsd-kind-icon">params</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="state.ng2statedeclaration.html#parent" class="tsd-kind-icon">parent</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="state.ng2statedeclaration.html#redirectto" class="tsd-kind-icon">redirect<wbr>To</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="state.ng2statedeclaration.html#reloadonsearch" class="tsd-kind-icon">reload<wbr>OnSearch</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="state.ng2statedeclaration.html#resolve" class="tsd-kind-icon">resolve</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="state.ng2statedeclaration.html#resolvepolicy" class="tsd-kind-icon">resolve<wbr>Policy</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="state.ng2statedeclaration.html#url" class="tsd-kind-icon">url</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite"><a href="state.ng2statedeclaration.html#views" class="tsd-kind-icon">views</a></li>
							</ul>
						</section>
					</div>
				</section>
    ...
    -->
						...
						<ul class="tsd-parameters">
							<li class="tsd-parameter-siganture">
								<ul class="tsd-signatures tsd-kind-type-literal tsd-parent-kind-property tsd-is-not-exported">
									<li class="tsd-signature tsd-kind-icon"><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">StateObject</span></li>
								</ul>
					...
					<aside class="tsd-sources">
						<p>Inherited from StateDeclaration.$$state</p>
						<ul>
							<li>Defined in angular/node_modules/@uirouter/core/lib/state/interface.d.ts:180</li>
						</ul>
					</aside>
				</section>
    ...
    -->
					<div class="tsd-signature tsd-kind-icon">$context<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">ViewContext</span>    <div class="tsd-header">
					...
					<aside class="tsd-sources">
						<p>Inherited from _ViewDeclaration.$context</p>
						<ul>
							<li>Defined in angular/node_modules/@uirouter/core/lib/state/interface.d.ts:71</li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited tsd-is-external">
    ...
    -->
					...
					<aside class="tsd-sources">
						<p>Inherited from _ViewDeclaration.$name</p>
						<ul>
							<li>Defined in angular/node_modules/@uirouter/core/lib/state/interface.d.ts:39</li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited tsd-is-external">
    ...
    -->
					...
					<aside class="tsd-sources">
						<p>Inherited from _ViewDeclaration.$type</p>
						<ul>
							<li>Defined in angular/node_modules/@uirouter/core/lib/state/interface.d.ts:66</li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited tsd-is-external">
    ...
    -->
					...
					<aside class="tsd-sources">
						<p>Inherited from _ViewDeclaration.$uiViewContextAnchor</p>
						<ul>
							<li>Defined in angular/node_modules/@uirouter/core/lib/state/interface.d.ts:58</li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited tsd-is-external">
    ...
    -->
					...
					<aside class="tsd-sources">
						<p>Inherited from _ViewDeclaration.$uiViewName</p>
						<ul>
							<li>Defined in angular/node_modules/@uirouter/core/lib/state/interface.d.ts:51</li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
    ...
    -->
					...
					<aside class="tsd-sources">
						<p>Inherited from StateDeclaration.abstract</p>
						<ul>
							<li>Defined in angular/node_modules/@uirouter/core/lib/state/interface.d.ts:147</li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
    ...
    -->
					<div class="tsd-signature tsd-kind-icon">bindings<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span>    <div class="tsd-header">
							<p> An object which maps <code>resolve</code> keys to <a href="state.ng2statedeclaration.html#component">component</a> <code>bindings</code>. </p>
						</div>
					</div>
					<div class="tsd-declaration">
						<div class="tsd-comment tsd-typography">
							...
							<p>A property of <a href="state.ng2statedeclaration.html">Ng2StateDeclaration</a> or <a href="state.ng2viewdeclaration.html">Ng2ViewDeclaration</a>:</p>
							<p>When using a <a href="state.ng2statedeclaration.html#component">component</a> declaration (<code>component: MyComponent</code>), each input binding for the component is supplied
								data from a resolve of the same name, by default.  You may supply data from a different resolve name by mapping it here.
							This might be useful if you want to reuse the same resolve value with various components with different input binding names.</p>
							<p>Each key in this object is the name of one of the component&#39;s input bindings.
							Each value is the name of the resolve that should be provided to that binding.</p>
							<p>Any component bindings that are omitted from this map get the default behavior of mapping to a resolve of the * same name.</p>
							<h4 id="example-">Example:</h4>
							<p>```js
							...
							<p>export function getUsers(userservice) {
					...
					<aside class="tsd-sources">
						<p>Inherited from <a href="state.ng2viewdeclaration.html">Ng2ViewDeclaration</a>.<a href="state.ng2viewdeclaration.html#bindings">bindings</a></p>
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/angular/blob/76dac28/src/interface.ts#L329">angular/src/interface.ts:329</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
    ...
    -->
					<div class="tsd-signature tsd-kind-icon">component<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">Type</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span>    <div class="tsd-header">
							<p> The <code>Component</code> class to use for this view. </p>
						</div>
					</div>
					<div class="tsd-declaration">
						<div class="tsd-comment tsd-typography">
							...
							<p>A property of <a href="state.ng2statedeclaration.html">Ng2StateDeclaration</a> or <a href="state.ng2viewdeclaration.html">Ng2ViewDeclaration</a>:</p>
							<h3 id="the-component-class-which-will-be-used-for-this-view-">The component class which will be used for this view.</h3>
							<h4 id="example-">Example:</h4>
							<pre><code class="lang-js">.state(<span class="hljs-string">'profile'</span>, {
  <span class="hljs-comment">// Use the &lt;my-profile&gt;&lt;/my-profile&gt; component for the Unnamed view</span>
  component: MyProfileComponent,
}

.state(<span class="hljs-string">'messages'</span>, {
  <span class="hljs-comment">// use the &lt;nav-bar&gt;&lt;/nav-bar&gt; component for the view named 'header'</span>
  <span class="hljs-comment">// use the &lt;message-list&gt;&lt;/message-list&gt; component for the view named 'content'</span>
  views: {
    <span class="hljs-attr">header</span>: { <span class="hljs-attr">component</span>: NavBar },
    <span class="hljs-attr">content</span>: { <span class="hljs-attr">component</span>: MessageList }
  }
}

<span class="hljs-comment">// Named views shorthand:</span>
<span class="hljs-comment">// Inside a "views:" block, a Component class (NavBar) is shorthand for { component: NavBar }</span>
.state(<span class="hljs-string">'contacts'</span>, {
  <span class="hljs-comment">// use the &lt;nav-bar&gt;&lt;/nav-bar&gt; component for the view named 'header'</span>
  <span class="hljs-comment">// use the &lt;contact-list&gt;&lt;/contact-list&gt; component for the view named 'content'</span>
  views: {
    <span class="hljs-attr">header</span>: NavBar,
    <span class="hljs-attr">content</span>: ContactList
  }
}
</code></pre>
							<h3 id="accessing-resolve-data">Accessing Resolve Data</h3>
							<p>The component can access the Transition&#39;s <a href="state.ng2statedeclaration.html#resolve">Ng2StateDeclaration.resolve</a> data in one of two ways:</p>
							<p>1) Using Dependency Injection in the component constructor</p>
  ...
  <span class="hljs-keyword">constructor</span>(@Inject("myResolveData") public resolveValueA, resolveValueB: public SomeClass) {
  }
}
</code></pre>
							<p>(using ES6/7/babel)</p>
							<pre><code class="lang-js"><span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">MyComponent</span> </span>{
  <span class="hljs-keyword">static</span> get parameters() {
    <span class="hljs-keyword">return</span> [[<span class="hljs-string">"myResolveData"</span>], [MyResolveClass]];
  }
  <span class="hljs-keyword">constructor</span>(resolveValueA, resolveValueB) {
    <span class="hljs-keyword">this</span>.resolveValueA = resolveValueA;
    <span class="hljs-keyword">this</span>.resolveValueB = resolveValueB;
  }
}
</code></pre>
							<p>See also: <a href="https://github.com/shuhei/babel-plugin-angular2-annotations">https://github.com/shuhei/babel-plugin-angular2-annotations</a></p>
							<p>2) Using a component input</p>
							<p>Note: To bind a resolve to a component input, the resolves must <code>provide:</code> a string value</p>
							<p>```js</p>
							<dl class="tsd-comment-tags">
								<dt>component</dt>
								<dd><p>() {
										...
										myResolveValueA;
										@Input() resolveValueB;
									@Input(&quot;resolveValueC&quot;) resolveValueC;</p>
									<p>  constructor() {
										}
										}
									```</p>
					...
					<aside class="tsd-sources">
						<p>Inherited from <a href="state.ng2viewdeclaration.html">Ng2ViewDeclaration</a>.<a href="state.ng2viewdeclaration.html#component">component</a></p>
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/angular/blob/76dac28/src/interface.ts#L287">angular/src/interface.ts:287</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
    ...
    -->
					...
					<aside class="tsd-sources">
						<p>Inherited from StateDeclaration.data</p>
						<ul>
							<li>Defined in angular/node_modules/@uirouter/core/lib/state/interface.d.ts:429</li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
    ...
    -->
					...
					<div class="tsd-declaration">
						<div class="tsd-comment tsd-typography">
							...
							The function must retur a promise which resolves when loading is complete.</p>
...
<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> lazyLoadResults;
					...
					<div class="tsd-type-declaration">
						...
						<ul class="tsd-parameters">
							<li class="tsd-parameter-siganture">
								<ul class="tsd-signatures tsd-kind-type-literal tsd-parent-kind-property tsd-is-not-exported">
									<li class="tsd-signature tsd-kind-icon"><span class="tsd-signature-symbol">(</span>transition<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Transition</span>, state<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">StateDeclaration</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">LazyLoadResult</span><span class="tsd-signature-symbol">&gt;</span></li>
								</ul>
								<ul class="tsd-descriptions">
									<li class="tsd-description">
										...
										<ul class="tsd-parameters">
											...
											<li>
												<h5>state <span class="tsd-signature-type">StateDeclaration</span></h5>
											</li>
										</ul>
										<div class="tsd-returns">
					...
					<aside class="tsd-sources">
						<p>Inherited from StateDeclaration.lazyLoad</p>
						<ul>
							<li>Defined in angular/node_modules/@uirouter/core/lib/state/interface.d.ts:684</li>
						</ul>
					</aside>
				</section>
    ...
    -->
					<div class="tsd-signature tsd-kind-icon">load<wbr>Children<span class="tsd-signature-symbol">:</span> <a href="../modules/core.html#ngmoduletoload" class="tsd-signature-type">NgModuleToLoad</a>    <div class="tsd-header">
							<p> A string or function used to lazy load an <code>NgModule</code> </p>
						</div>
					</div>
					<div class="tsd-declaration">
						<div class="tsd-comment tsd-typography">
							...
							<p>The <code>loadChildren</code> property should be added to a Future State (a lazy loaded state whose name ends in <code>.**</code>).
							The Future State is a placeholder for a tree of states that will be lazy loaded in the future.</p>
							<p>When the future state is activated, the <code>loadChildren</code> property will lazy load an <code>NgModule</code>
								which contains the fully loaded states.
								The <code>NgModule</code> should contain the fully loaded states which will be registered.
							The fully loaded states will replace the temporary future states once lazy loading is complete.</p>
							<hr>
							<p>When <code>loadChildren</code> is a string, it should be a relative path to the module code that will be lazy loaded.
								It should follow the semantics of the Angular Router&#39;s <code>loadChildren</code> property.
								The string will be split in half on the hash character (<code>#</code>).
								The first half is the path to the module.
							The last half is the named export of the <code>NgModule</code> inside the ES6 module.</p>
							<h4 id="example-">Example:</h4>
							<p>home.module.ts</p>
							<p>```</p>
							<dl class="tsd-comment-tags">
								<dt>ngmodule</dt>
								<dd><p>({... })
									export class HomeModule {};</p>
									<pre><code>
```js
var futureState = {
  name: <span class="hljs-string">'home.**'</span>,
  url: <span class="hljs-string">'/home'</span>,
  loadChildren: <span class="hljs-string">'./home/home.module#HomeModule'</span>)
}
</code></pre><p>As a function, it should return a promise for the <code>NgModule</code></p>
									<h4 id="example-">Example:</h4>
									<pre><code class="lang-js"><span class="hljs-keyword">var</span> futureState = {
  <span class="hljs-attr">name</span>: <span class="hljs-string">'home.**'</span>,
  <span class="hljs-attr">url</span>: <span class="hljs-string">'/home'</span>,
  <span class="hljs-attr">loadChildren</span>: <span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> System.import(<span class="hljs-string">'./home/home.module'</span>)
      .then(<span class="hljs-function"><span class="hljs-params">result</span> =&gt;</span> result.HomeModule);
}
</code></pre>
									<h4 id="example-">Example:</h4>
									<p>This shows the load function being exported for compatibility with the AoT compiler.</p>
									<pre><code class="lang-js"><span class="hljs-keyword">export</span> <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">loadHomeModule</span>(<span class="hljs-params"></span>) </span>{
  <span class="hljs-keyword">return</span> System.import(<span class="hljs-string">'./home/home.module'</span>)
      .then(<span class="hljs-function"><span class="hljs-params">result</span> =&gt;</span> result.HomeModule);
}

<span class="hljs-keyword">var</span> futureState = {
  <span class="hljs-attr">name</span>: <span class="hljs-string">'home.**'</span>,
  <span class="hljs-attr">url</span>: <span class="hljs-string">'/home'</span>,
  <span class="hljs-attr">loadChildren</span>: loadHomeModule
}
</code></pre>
								</dd>
							</dl>
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/angular/blob/76dac28/src/interface.ts#L201">angular/src/interface.ts:201</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
    ...
    -->
					...
					<aside class="tsd-sources">
						<p>Inherited from StateDeclaration.name</p>
						<ul>
							<li>Defined in angular/node_modules/@uirouter/core/lib/state/interface.d.ts:140</li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
    ...
    -->
					<div class="tsd-signature tsd-kind-icon">on<wbr>Enter<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">TransitionStateHookFn</span>    <div class="tsd-header">
  ...
  <span class="hljs-built_in">console</span>.log(<span class="hljs-string">"Entering "</span> + state.name);
					...
					<aside class="tsd-sources">
						<p>Inherited from StateDeclaration.onEnter</p>
						<ul>
							<li>Defined in angular/node_modules/@uirouter/core/lib/state/interface.d.ts:517</li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
    ...
    -->
					<div class="tsd-signature tsd-kind-icon">on<wbr>Exit<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">TransitionStateHookFn</span>    <div class="tsd-header">
  ...
  <span class="hljs-built_in">console</span>.log(<span class="hljs-string">"Leaving "</span> + state.name);
					...
					<aside class="tsd-sources">
						<p>Inherited from StateDeclaration.onExit</p>
						<ul>
							<li>Defined in angular/node_modules/@uirouter/core/lib/state/interface.d.ts:561</li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
    ...
    -->
					<div class="tsd-signature tsd-kind-icon">on<wbr>Retain<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">TransitionStateHookFn</span>    <div class="tsd-header">
  ...
  <span class="hljs-built_in">console</span>.log(state.name + <span class="hljs-string">" is still active!"</span>);
					...
					<aside class="tsd-sources">
						<p>Inherited from StateDeclaration.onRetain</p>
						<ul>
							<li>Defined in angular/node_modules/@uirouter/core/lib/state/interface.d.ts:539</li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
  ...
  <span class="hljs-attr">param2</span>: {
    <span class="hljs-attr">value</span>: <span class="hljs-string">"index"</span>
					...
					<aside class="tsd-sources">
						<p>Inherited from StateDeclaration.params</p>
						<ul>
							<li>Defined in angular/node_modules/@uirouter/core/lib/state/interface.d.ts:366</li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
    ...
    -->
					<div class="tsd-signature tsd-kind-icon">parent<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">StateDeclaration</span>    <div class="tsd-header">
					...
					<div class="tsd-declaration">
						<div class="tsd-comment tsd-typography">
							...
							<p>Normally, a state&#39;s parent is implied from the state&#39;s <a href="state.ng2statedeclaration.html#name">name</a>, e.g., <code>&quot;parentstate.childstate&quot;</code>.</p>
...
<span class="hljs-keyword">var</span> childstate = {
  ...
  <span class="hljs-comment">// parent: parentstate</span>
					...
					<aside class="tsd-sources">
						<p>Inherited from StateDeclaration.parent</p>
						<ul>
							<li>Defined in angular/node_modules/@uirouter/core/lib/state/interface.d.ts:172</li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
    ...
    -->
					<div class="tsd-signature tsd-kind-icon">redirect<wbr>To<span class="tsd-signature-symbol">:</span> <a href="../modules/state.html#redirecttoresult" class="tsd-signature-type">RedirectToResult</a><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">function</span>    <div class="tsd-header">
...
.state(<span class="hljs-string">'G'</span>, {
  <span class="hljs-attr">redirectTo</span>: <span class="hljs-function">(<span class="hljs-params">trans</span>) =&gt;</span> {
    ...
    <span class="hljs-keyword">return</span> resolvePromise.then(<span class="hljs-function"><span class="hljs-params">resolveData</span> =&gt;</span> resolveData === <span class="hljs-string">'login'</span> ? <span class="hljs-string">'login'</span> : <span class="hljs-literal">null</span>);
					...
					<aside class="tsd-sources">
						<p>Inherited from StateDeclaration.redirectTo</p>
						<ul>
							<li>Defined in angular/node_modules/@uirouter/core/lib/state/interface.d.ts:495</li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
    ...
    -->
					...
					<aside class="tsd-sources">
						<p>Inherited from StateDeclaration.reloadOnSearch</p>
						<ul>
							<li>Defined in angular/node_modules/@uirouter/core/lib/state/interface.d.ts:688</li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
    ...
    -->
					<div class="tsd-signature tsd-kind-icon">resolve<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">Array</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">Resolvable</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">ResolvableLiteral</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">ProviderLike</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">object</span>    <div class="tsd-header">
  ...
  myAsyncData: [<span class="hljs-string">'$http'</span>, <span class="hljs-string">'$transition$'</span> <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">$http, $transition$</span>) </span>{
    ...
    <span class="hljs-keyword">return</span> $http.get(<span class="hljs-string">"/foos/"</span> + $transition$.params().foo);
							...
							<ul>
								<li><code>UIRouter</code>: The <a href="../classes/core.uirouter.html">UIRouter</a> instance which has references to all the UI-Router services.</li>
...
resolve: [
  ...
  { <span class="hljs-attr">provide</span>: <span class="hljs-string">'user'</span>, (allusers, trans) =&gt; _.find(allusers, trans.params().userId, <span class="hljs-attr">deps</span>: [<span class="hljs-string">'allusers'</span>, Transition] }
					...
					<aside class="tsd-sources">
						<p>Inherited from StateDeclaration.resolve</p>
						<ul>
							<li>Defined in angular/node_modules/@uirouter/core/lib/state/interface.d.ts:301</li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
    ...
    -->
					<div class="tsd-signature tsd-kind-icon">resolve<wbr>Policy<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">ResolvePolicy</span>    <div class="tsd-header">
					...
					<aside class="tsd-sources">
						<p>Inherited from StateDeclaration.resolvePolicy</p>
						<ul>
							<li>Defined in angular/node_modules/@uirouter/core/lib/state/interface.d.ts:316</li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
...
url: <span class="hljs-string">"/messages/:mailboxid?{before:date}&amp;{after:date}"</span>
					...
					<aside class="tsd-sources">
						<p>Inherited from StateDeclaration.url</p>
						<ul>
							<li>Defined in angular/node_modules/@uirouter/core/lib/state/interface.d.ts:345</li>
						</ul>
					</aside>
				</section>
    ...
    -->
					<div class="tsd-signature tsd-kind-icon">views<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">object</span>    <div class="tsd-header">
							<p> An optional object used to define multiple named views. </p>
						</div>
					</div>
					<div class="tsd-declaration">
						<div class="tsd-comment tsd-typography">
							...
							<p>Each key is the name of a view, and each value is a <a href="state.ng2viewdeclaration.html">Ng2ViewDeclaration</a>.
							Unnamed views are internally renamed to <code>$default</code>.</p>
							<p>A view&#39;s name is used to match an active <code>&lt;ui-view&gt;</code> directive in the DOM.  When the state
							is entered, the state&#39;s views are activated and then matched with active <code>&lt;ui-view&gt;</code> directives:</p>
							<ul>
								<li><p>The view&#39;s name is processed into a ui-view target:</p>
									<ul>
										<li>ui-view address: an address to a ui-view</li>
										<li>state anchor: the state to anchor the address to</li>
									</ul>
									<p>Examples:</p>
  ...
  <span class="hljs-attr">header</span>: {<span class="hljs-attr">component</span>: HeaderComponent},
  <span class="hljs-attr">body</span>: {<span class="hljs-attr">component</span>: BodyComponent},
  <span class="hljs-attr">footer</span>: {<span class="hljs-attr">component</span>: FooterComponent}
}
</code></pre>
							<h4 id="example-">Example:</h4>
							<pre><code class="lang-js"><span class="hljs-comment">// Targets named ui-view="header" in the template of the ancestor state 'top'</span>
<span class="hljs-comment">// and the named `ui-view="body" from the parent state's template.</span>
views: {
  <span class="hljs-string">'header@top'</span>: {<span class="hljs-attr">component</span>: MsgHeaderComponent},
  <span class="hljs-string">'body'</span>: {<span class="hljs-attr">component</span>: MessagesComponent}
}
</code></pre>
							<h2 id="view-targeting-details">View targeting details</h2>
							<p>There are a few styles of view addressing/targeting.  The most common is a simple <code>ui-view</code> name</p>
							<h4 id="simple-ui-view-name">Simple ui-view name</h4>
							<p>Addresses without an <code>@</code> are anchored to the parent state.</p>
							<h4 id="example-">Example:</h4>
							<pre><code class="lang-js"><span class="hljs-comment">// target the `&lt;div ui-view='foo'&gt;&lt;/div&gt;` created in the parent state's view</span>
views: { <span class="hljs-attr">foo</span>: {...} }
</code></pre>
							<h4 id="view-name-anchored-to-a-state">View name anchored to a state</h4>
							<p>You can anchor the <code>ui-view</code> name to a specific state by including an <code>@</code></p>
							<dl class="tsd-comment-tags">
								<dt>example</dt>
								<dd><pre><code class="lang-js">
<span class="hljs-comment">// target the `&lt;div ui-view='foo'&gt;&lt;/div&gt;` which was created in a</span>
<span class="hljs-comment">// view owned by the state `bar.baz`</span>
views: { <span class="hljs-string">'foo@bar.baz'</span>: {...} }
</code></pre>
									<h4 id="absolute-addressing">Absolute addressing</h4>
									<p>You can address a <code>ui-view</code> absolutely, using dotted notation, by prefixing the address with a <code>!</code>.  Dotted
									addresses map to the hierarchy of <code>ui-view</code>s active in the DOM:</p>
									<h4 id="example-">Example:</h4>
									<pre><code class="lang-js"><span class="hljs-comment">// absolutely target the `&lt;div ui-view='nested'&gt;&lt;/div&gt;`... which was created</span>
<span class="hljs-comment">// in the unnamed/$default root `&lt;ui-view&gt;&lt;/ui-view&gt;`</span>
views: { <span class="hljs-string">'!$default.nested'</span>: {...} }
</code></pre>
									<h4 id="relative-addressing">Relative addressing</h4>
									<p>Absolute addressing is actually relative addressing, only anchored to the unnamed root state.  You can also use
									relative addressing anchored to any state, in order to target a target deeply nested <code>ui-views</code>:</p>
									<h4 id="example-">Example:</h4>
									<pre><code class="lang-js">
<span class="hljs-comment">// target the `&lt;div ui-view='bar'&gt;&lt;/div&gt;`... which was created inside the</span>
<span class="hljs-comment">// `&lt;div ui-view='bar'&gt;&lt;/div&gt;`... which was created inside the parent state's template.</span>
views: { <span class="hljs-string">'foo.bar'</span>: {...} }
</code></pre>
									<h4 id="example-">Example:</h4>
									<p><code>``js
// target the</code><div ui-view='bar'></div><code>...  which was created in
//</code><div ui-view='foo'></div><code>... which was created in a template crom the state</code>baz.qux`
									views: { &#39;foo.bar@baz.qux&#39;: {...} }</p>
									<hr>
									<h2 id="state-component-and-views-incompatiblity">State <code>component:</code> and <code>views:</code> incompatiblity</h2>
									<p>If a state has a <code>views</code> object, the state-level <code>component:</code> property is ignored.  Therefore,
										if <em>any view</em> for a state is declared in the <code>views</code> object, then <em>all of the state&#39;s views</em> must be defined in
					...
					<div class="tsd-type-declaration">
						...
						<ul class="tsd-parameters">
							<li class="tsd-parameter-index-signature">
								<h5><span class="tsd-signature-symbol">[</span>key: <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">]: </span><a href="state.ng2viewdeclaration.html" class="tsd-signature-type">Ng2ViewDeclaration</a></h5>
							</li>
						</ul>
					</div>
					<aside class="tsd-sources">
						<p>Overwrites StateDeclaration.views</p>
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/angular/blob/76dac28/src/interface.ts#L135">angular/src/interface.ts:135</a></li>
						</ul>
					</aside>
				</section>
			</section>
		...
		<div class="col-4 col-menu menu-sticky-wrap menu-highlight">
			<nav class="tsd-navigation primary">
				<ul>
					...
					<li class=" tsd-kind-external-module tsd-is-external">
						<a href="../modules/_core_src_hooks_ignoredtransition_.html">"core/src/hooks/ignored<wbr>Transition"</a>
					</li>
					<li class=" tsd-kind-external-module tsd-is-external">
						<a href="../modules/_core_src_hooks_invalidtransition_.html">"core/src/hooks/invalid<wbr>Transition"</a>
					</li>
					<li class=" tsd-kind-external-module tsd-is-external">
			...
			<nav class="tsd-navigation secondary menu-sticky">
				<ul class="before-current">
					...
					<li class=" tsd-kind-interface tsd-parent-kind-external-module">
						<a href="state.ng2component.html" class="tsd-kind-icon">Ng2<wbr>Component</a>
					</li>
				</ul>
				<ul class="current">
					<li class="current tsd-kind-interface tsd-parent-kind-external-module">
						<a href="state.ng2statedeclaration.html" class="tsd-kind-icon">Ng2<wbr>State<wbr>Declaration</a>
						<ul>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="state.ng2statedeclaration.html#__state" class="tsd-kind-icon">$$state</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited tsd-is-external">
								<a href="state.ng2statedeclaration.html#_context" class="tsd-kind-icon">$context</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited tsd-is-external">
								<a href="state.ng2statedeclaration.html#_name" class="tsd-kind-icon">$name</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited tsd-is-external">
								<a href="state.ng2statedeclaration.html#_type" class="tsd-kind-icon">$type</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited tsd-is-external">
								<a href="state.ng2statedeclaration.html#_uiviewcontextanchor" class="tsd-kind-icon">$ui<wbr>View<wbr>Context<wbr>Anchor</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited tsd-is-external">
								<a href="state.ng2statedeclaration.html#_uiviewname" class="tsd-kind-icon">$ui<wbr>View<wbr>Name</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="state.ng2statedeclaration.html#abstract" class="tsd-kind-icon">abstract</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="state.ng2statedeclaration.html#bindings" class="tsd-kind-icon">bindings</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="state.ng2statedeclaration.html#component" class="tsd-kind-icon">component</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="state.ng2statedeclaration.html#data" class="tsd-kind-icon">data</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="state.ng2statedeclaration.html#lazyload" class="tsd-kind-icon">lazy<wbr>Load</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface">
								<a href="state.ng2statedeclaration.html#loadchildren" class="tsd-kind-icon">load<wbr>Children</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="state.ng2statedeclaration.html#name" class="tsd-kind-icon">name</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="state.ng2statedeclaration.html#onenter" class="tsd-kind-icon">on<wbr>Enter</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="state.ng2statedeclaration.html#onexit" class="tsd-kind-icon">on<wbr>Exit</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="state.ng2statedeclaration.html#onretain" class="tsd-kind-icon">on<wbr>Retain</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="state.ng2statedeclaration.html#params" class="tsd-kind-icon">params</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="state.ng2statedeclaration.html#parent" class="tsd-kind-icon">parent</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="state.ng2statedeclaration.html#redirectto" class="tsd-kind-icon">redirect<wbr>To</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="state.ng2statedeclaration.html#reloadonsearch" class="tsd-kind-icon">reload<wbr>OnSearch</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="state.ng2statedeclaration.html#resolve" class="tsd-kind-icon">resolve</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="state.ng2statedeclaration.html#resolvepolicy" class="tsd-kind-icon">resolve<wbr>Policy</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="state.ng2statedeclaration.html#url" class="tsd-kind-icon">url</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite">
								<a href="state.ng2statedeclaration.html#views" class="tsd-kind-icon">views</a>
							</li>
						</ul>
					</li>
				</ul>
				<ul class="after-current">
					<li class=" tsd-kind-interface tsd-parent-kind-external-module">
						<a href="state.ng2viewdeclaration.html" class="tsd-kind-icon">Ng2<wbr>View<wbr>Declaration</a>
					</li>
					<li class=" tsd-kind-interface tsd-parent-kind-external-module">
