		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					...
					<pre><code class="lang-js"><span class="hljs-keyword">import</span> {StateRegistry} <span class="hljs-keyword">from</span> <span class="hljs-string">"@uirouter/angular"</span>;
</code></pre>
					<ul>
						<li>Create application states (as defined by <a href="../interfaces/state.ng2statedeclaration.html">Ng2StateDeclaration</a>).</li>
					</ul>
					<pre><code class="lang-js"><span class="hljs-keyword">export</span> <span class="hljs-keyword">let</span> state1: Ng2StateDeclaration = {
...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">MyFeatureModule</span> </span>{}
</code></pre>
					<ul>
...
browserPlatformDynamic.bootstrapModule(RootAppModule);
					...
					<pre><code class="lang-js"><span class="hljs-keyword">import</span> {UIRouter} <span class="hljs-keyword">from</span> <span class="hljs-string">"@uirouter/angular"</span>;
...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">MyUIRouterConfig</span> </span>{
  ...
  <span class="hljs-keyword">constructor</span>(uiRouter: UIRouter) {
    uiRouter.urlMatcherFactory.type(<span class="hljs-string">'datetime'</span>, myDateTimeParamType);
			...
			<section class="tsd-panel-group tsd-member-group tsd-is-external">
				...
				<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-external-module tsd-is-external">
					...
					<!--
        <h3>UIROUTER_<wbr>PROVIDERS</h3>
    -->
					<div class="tsd-signature tsd-kind-icon">UIROUTER_<wbr>PROVIDERS<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">Provider</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol"> =&nbsp;_UIROUTER_INSTANCE_PROVIDERS.concat(_UIROUTER_SERVICE_PROVIDERS)</span>    <div class="tsd-header">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/angular/blob/76dac28/src/providers.ts#L197">angular/src/providers.ts:197</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-external-module tsd-is-external">
					...
					<!--
        <h3>_UIROUTER_<wbr>INSTANCE_<wbr>PROVIDERS</h3>
    -->
					<div class="tsd-signature tsd-kind-icon">_UIROUTER_<wbr>INSTANCE_<wbr>PROVIDERS<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">Provider</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol"> =&nbsp;[{ provide: UIRouter, useFactory: uiRouterFactory, deps: [LocationStrategy, UIROUTER_ROOT_MODULE, UIROUTER_MODULE_TOKEN, Injector] },{ provide: UIView.PARENT_INJECT, useFactory: parentUIViewInjectFactory, deps: [StateRegistry]},]</span></div>
					<div class="tsd-declaration">
					</div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/angular/blob/76dac28/src/providers.ts#L167">angular/src/providers.ts:167</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-external-module tsd-is-external">
    ...
    -->
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/angular/blob/76dac28/src/statebuilders/views.ts#L40">angular/src/statebuilders/views.ts:40</a></li>
						</ul>
					</aside>
				</section>
			</section>
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<div class="tsd-returns">
								<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">StateObject</span><span class="tsd-signature-symbol">[]</span></h4>
							</div>
							<hr>
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/angular/blob/76dac28/src/uiRouterConfig.ts#L7">angular/src/uiRouterConfig.ts:7</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/angular/blob/76dac28/src/uiRouterConfig.ts#L16">angular/src/uiRouterConfig.ts:16</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/angular/blob/76dac28/src/providers.ts#L179">angular/src/providers.ts:179</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/angular/blob/76dac28/src/providers.ts#L178">angular/src/providers.ts:178</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/angular/blob/76dac28/src/providers.ts#L172">angular/src/providers.ts:172</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/angular/blob/76dac28/src/providers.ts#L173">angular/src/providers.ts:173</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/angular/blob/76dac28/src/providers.ts#L174">angular/src/providers.ts:174</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/angular/blob/76dac28/src/providers.ts#L175">angular/src/providers.ts:175</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/angular/blob/76dac28/src/providers.ts#L176">angular/src/providers.ts:176</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/angular/blob/76dac28/src/providers.ts#L177">angular/src/providers.ts:177</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<div class="tsd-comment tsd-typography">
								...
								<pre><code class="lang-js"><span class="hljs-keyword">var</span> decl = {
  <span class="hljs-attr">ngModule</span>: <span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> System.import(<span class="hljs-string">'./childModule.ts'</span>)
								...
								<pre><code class="lang-js"><span class="hljs-keyword">import</span> { loadNgModule } <span class="hljs-keyword">from</span> <span class="hljs-string">"@uirouter/angular"</span>;
...
<span class="hljs-keyword">var</span> decl = {
  <span class="hljs-attr">lazyLoad</span>: <span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> System.import(<span class="hljs-string">'third-party-library'</span>)
      .then(<span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> loadNgModule(<span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> System.import(<span class="hljs-string">'./childModule.ts'</span>))
								...
								<ul class="tsd-parameters">
									<li class="tsd-parameter-siganture">
										<ul class="tsd-signatures tsd-kind-type-literal tsd-is-not-exported">
											<li class="tsd-signature tsd-kind-icon"><span class="tsd-signature-symbol">(</span>transition<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Transition</span>, state<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">StateDeclaration</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">StateDeclaration</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">&gt;</span></li>
										</ul>
										<ul class="tsd-descriptions">
											<li class="tsd-description">
												<h4 class="tsd-parameters-title">Parameters</h4>
												...
												<div class="tsd-returns">
													<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">StateDeclaration</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">&gt;</span></h4>
												</div>
											</li>
										</ul>
									</li>
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/angular/blob/76dac28/src/statebuilders/lazyLoad.ts#L50">angular/src/statebuilders/lazyLoad.ts:50</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/angular/blob/76dac28/src/statebuilders/views.ts#L19">angular/src/statebuilders/views.ts:19</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/angular/blob/76dac28/src/providers.ts#L165">angular/src/providers.ts:165</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-external-module tsd-is-external">
						<li class="tsd-signature tsd-kind-icon">ui<wbr>Router<wbr>Factory<span class="tsd-signature-symbol">(</span>locationStrategy<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">LocationStrategy</span>, rootModules<span class="tsd-signature-symbol">: </span><a href="../interfaces/core.rootmodule.html" class="tsd-signature-type">RootModule</a><span class="tsd-signature-symbol">[]</span>, modules<span class="tsd-signature-symbol">: </span><a href="../interfaces/core.statesmodule.html" class="tsd-signature-type">StatesModule</a><span class="tsd-signature-symbol">[]</span>, injector<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Injector</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">UIRouter</span></li>
						<li class="tsd-header">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<ul class="tsd-parameters">
								...
								<li>
									<h5>rootModules <a href="../interfaces/core.rootmodule.html" class="tsd-signature-type">RootModule</a><span class="tsd-signature-symbol">[]</span></h5>
								</li>
								<li>
									<h5>modules <a href="../interfaces/core.statesmodule.html" class="tsd-signature-type">StatesModule</a><span class="tsd-signature-symbol">[]</span></h5>
								</li>
								<li>
									<h5>injector <span class="tsd-signature-type">Injector</span></h5>
								</li>
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/angular/blob/76dac28/src/providers.ts#L111">angular/src/providers.ts:111</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
